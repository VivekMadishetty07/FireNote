...
public class MoveAdapter extends RecyclerView.Adapter<com.example.firenote.Adapter.MoveAdapter.MyViewHolder>
{
    ...
    @Override
    public com.example.firenote.Adapter.MoveAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.categorylayout, parent, false);
        return new com.example.firenote.Adapter.MoveAdapter.MyViewHolder(itemView);
    }

    @SuppressLint("ResourceAsColor")
    @Override
    public void onBindViewHolder(final com.example.firenote.Adapter.MoveAdapter.MyViewHolder holder, final int position)
    {
